class Grid(var grid:Vector[Int] = Vector.fill(6*7)(0),val rows: Int = 6, val columns:Int = 7,
  ...
  def set(i:Int, value: Int): Unit = grid = grid.updated(i,value)
...
test.put(6,1)
println(test.toString)
println(test.checkConnect4(1))

(0 to 35 by 7).toVector
(6 to 41 by 7).toVector